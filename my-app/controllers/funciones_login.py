...
def recibeInsertRegisterUser(cedula, name, surname, id_area, id_rol, pass_user, direccion):
        ...
        try:
            with connectionBD() as conexion_MySQLdb:
                with conexion_MySQLdb.cursor(dictionary=True) as mycursor:
                    sql = """
                    INSERT INTO usuarios(cedula, nombre_usuario, apellido_usuario, id_area, id_rol, password, direccion_usuario) 
                    VALUES (%s, %s, %s, %s, %s, %s, %s)
                    """
                    valores = (cedula, name, surname, id_area, id_rol, nueva_password, direccion)
...
def info_perfil_session(id):
    ...
    try:
        with connectionBD() as conexion_MySQLdb:
            with conexion_MySQLdb.cursor(dictionary=True) as cursor:
                querySQL = "SELECT id_usuario, nombre_usuario, apellido_usuario, direccion_usuario, cedula, id_area, id_rol FROM usuarios WHERE id_usuario = %s"
